...
const stripe = require('stripe')(
  'sk_test_51IgW8cIXwT38my0aJiBhw4YHO8xtVt49kOEV7NONO251J7TaZBhW402AUj0s7FMYdgP0ojiq4CnP5WX5q5qChrPI00yochtDIm'
);
    ...
    try {
      ...
      if (checkEmail) {
        ...
        const paymentIntent = await stripe.paymentIntents.create(
          {
            amount: Number(allProductPrice) * 100,
            currency: 'EUR',
        ...
        await userDataMapper.updateItem(itemStringed, email);
    ...
    try {
      ...
      if (checkEmail) {
        ...
        if (subscription.status === 'active') {
          ...
          await userDataMapper.subscriptionEnd(
